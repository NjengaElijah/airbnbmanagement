...
<head>
    ...
    <meta name="author" content="NjengaELijah" />
    <!-- Favicon icon -->
...
<body class="">
    ...
    <header class="navbar pcoded-header navbar-expand-lg navbar-light header-dark">
        ...
        <div class="m-header">
            ...
            <a href="#!" class="b-brand">
                ...
                <h5 class="text-light">{{ config('app.name') }}</h5>
            </a>
    ...
    <script>
        $(function() {
            ...
            //on click button asking for confirmation
            $(document).on("click", "[is_modal]", function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        console.log("modal");
                        console.info(data)
                        $("#hand_modal").html(data).modal("show");
                    },
